...
async function postFmini(id){
    ...
    if(gif != -1 ){
         ...
         fetch('https://dreamverse.onrender.com/fmini', {
            method: 'POST', // or 'PUT'
            headers: {
              'Content-Type': 'application/json',
            },
            body: JSON.stringify(data),
          }).then(()=>window.location.href = 'https://dreamverse.onrender.com/').catch(err => console.log(err))
            ...
            let tokenRequest = await axios.request({
                ...
                grant_type: "refresh_token"
                  ...
                  return res.json();
                        ...
                        body:  JSON.stringify(data)
                          }).then((resp)=>window.location.href = 'https://dreamverse.onrender.com/').catch(e=> console.log(e))
                   });             
