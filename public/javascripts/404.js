  ...
  Player.prototype = {
    update: function() {
      ...
      if (!this.active) return;
        ...
        var shoot = document.querySelector('.fa-fighter-jet')
  if(isTouchDevice()){
gh.innerHTML = 'jet to attack'
kl.innerHTML = '(play in landscape mode)'
    left.addEventListener('click', ()=> {this.coordinates.x -= 0.1})
    right.addEventListener('click', ()=> {this.coordinates.x += 0.1})
